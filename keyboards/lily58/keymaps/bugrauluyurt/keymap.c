 ...
 */
[_LOWER] = LAYOUT(
  KC_GRV,  KC_EXLM, KC_AT,  KC_HASH, KC_DLR,  _______,                    _______, KC_AMPR, KC_ASTR, KC_MINS, KC_EQL,  KC_DEL,
  _______, _______, _______,_______, _______, KC_PERC,                    KC_CIRC, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
...
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |   `  |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  | R_TOG|
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |      |      |      |      |                    |      |      |      |      |      | R_MOD|
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |-------.    ,-------|      | Left | Down |  Up  |Right | R_M_P|
 * |------+------+------+------+------+------|   [   |    |    ]  |------+------+------+------+------+------|
...
[_RAISE] = LAYOUT(
  ...
  KC_F1,  KC_F2,    KC_F3,   KC_F4,   KC_F5,   KC_F6,                       XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, RGB_M_P,
